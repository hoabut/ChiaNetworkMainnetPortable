...
user in an INI file next to ChiaNetworkMainnetPortable.exe called ChiaNetworkMainnetPortable.ini.
...
copy AppNamePortable.ini from this directory to ChiaNetworkMainnetPortable.ini next to
ChiaNetworkMainnetPortable.exe. The options in the INI file are as follows:
